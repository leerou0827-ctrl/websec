...
import { X, PanelLeft, ShieldCheck, LayoutDashboard, Users, Settings, CheckSquare, History, LogOut } from "lucide-react";
...
function AppShell({ role }) {
  ...
  return /* @__PURE__ */ jsx(SidebarProvider, { children: /* @__PURE__ */ jsxs("div", { className: "flex min-h-screen w-full bg-muted/30", children: [
    /* @__PURE__ */ jsxs(Sidebar, { collapsible: "icon", children: [
      /* @__PURE__ */ jsx(SidebarHeader, { className: "border-b border-sidebar-border", children: /* @__PURE__ */ jsxs(Link, { to: "/", className: "flex items-center gap-2 px-2 py-2 text-sidebar-foreground", children: [
        /* @__PURE__ */ jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded-md bg-sidebar-primary text-sidebar-primary-foreground", children: /* @__PURE__ */ jsx(ShieldCheck, { className: "h-4 w-4" }) }),
        /* @__PURE__ */ jsx("span", { className: "font-semibold", children: "SecureAttend" })
      ] }) }),
      /* @__PURE__ */ jsx(SidebarContent, { children: /* @__PURE__ */ jsxs(SidebarGroup, { children: [
        /* @__PURE__ */ jsx(SidebarGroupLabel, { children: role === "admin" ? "Administration" : "Student" }),
        /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { asChild: true, isActive: path === item.url, children: /* @__PURE__ */ jsxs(Link, { to: item.url, className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(item.icon, { className: "h-4 w-4" }),
          /* @__PURE__ */ jsx("span", { children: item.title })
        ] }) }) }, item.title)) }) })
      ] }) }),
      /* @__PURE__ */ jsx(SidebarFooter, { className: "border-t border-sidebar-border", children: /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsxs(SidebarMenuButton, { onClick: handleLogout, children: [
        /* @__PURE__ */ jsx(LogOut, { className: "h-4 w-4" }),
        /* @__PURE__ */ jsx("span", { children: "Sign out" })
      ] }) }) }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col min-w-0", children: [
      /* @__PURE__ */ jsxs("header", { className: "sticky top-0 z-30 flex h-14 items-center gap-2 border-b border-border bg-background/80 px-3 backdrop-blur sm:px-4", children: [
        /* @__PURE__ */ jsx(SidebarTrigger, {}),
        /* @__PURE__ */ jsx("div", { className: "truncate text-sm font-medium text-foreground sm:font-normal sm:text-muted-foreground", children: role === "admin" ? "Administrator Console" : "Student Portal" }),
      ...
      /* @__PURE__ */ jsx("main", { className: "flex-1 p-4 sm:p-6 animate-fade-in", children: /* @__PURE__ */ jsx(Outlet, {}) })
    ] })
  ] }) });
}
export {
